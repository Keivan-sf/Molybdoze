const pages = {
    ...
    login_page : require('./users/users.js'),
...
module.exports = (express , app) => {
    ...
    app.get('/login' , (req , res) => pages.login_page(req , res)) 

    app.get('/signup' , (req , res) => pages.login_page(req , res , 'signup')) 

    app.post('/login-auth' , (req , res) => pages.login_page(req , res)) 
