...
const {execute} = require('../../utils/databaseUtils/sqlutils.js');
...
module.exports = (req , res) =>{
    ...
    values.videoFile.mv(mainFile , async(err)=>{
        ...
        try{
            ...
            console.log('qualities obj : ' , qualitiesFinished);
            console.log('qualitis sql:' , qualities)

            await Videos.insertVideo({VideoID : videoID , UserID : 'someID' , Title : videoID , Description: 'some Des here' , Likes: 0 , Dislikes : 0 , Views: 0 , Qualities: qualities.join('-')} , 'VideoDate')
